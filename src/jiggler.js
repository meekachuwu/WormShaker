...
Object.defineProperty(Jiggler.prototype, 'pos', {
  ...
  set: function(v) { this.__pos = v; this.__bound(v); }
})

Jiggler.prototype.bind = function(fnc) { this.__bound = fnc; }
...
Jiggler.update = function() {
  for (var i = 0, l = Jiggler.__all.length; i < l; i++) { Jiggler.__all[i].update(); }
}